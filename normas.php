  ...
  <main>
    <div class='container'>
      ...
      <article class="row espaço">
        ...
        <h2 class=" espaço titulos3">Termos e condições de uso do nosso portal </h2>
        ...
        <h3 class="titulos3">1.Da Função do Portal</h3>
        ...
        <h3 class="titulos3">2.Do Aceite de Termos</h3>
