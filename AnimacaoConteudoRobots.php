      ...
      <article>
        ...
        <div class='row mt-5'>
          <div class='col-xl-8 col-md-12 col-sm-12'>
            ...
            <small class='mb-3 d-block small pb-2 border-bottom border-2' aria-label='Link para a fonte do conteúdo da página'>Novembro 23, 2022 by <cite><a href="https://github.com/Dimitri13Freitas">Dimitri</a></cite></small>
        ...
        <figure class=' row my-3'>
          <div class='col-xl-7 col-md-12  col-sm-12 conteudo'>
            <img class='rounded' src="img/imgAnimacao/destaques/img1Conteudo.webp" alt="Imagem que representa a diversidade do estilos e premissas de Love, Death & Robots">
          </div>
