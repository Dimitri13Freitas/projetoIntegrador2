      ...
      <article>
        <div class='row mt-5'>
          <div class='col-xl-8 col-md-12 col-sm-12'>
            ...
            <small class='mb-3 d-block small pb-2 border-bottom border-2' aria-label='Link para a fonte do conteúdo da página'>Novembro 23, 2022 by <cite><a href="https://futurama.fandom/pt-br/wiki/Hist%C3%B3ria_de_Futurama">futurama.fandom.com</a></cite></small>
        ...
        <figure class=' row my-3'>
          <div class='col-xl-7 col-md-12  col-sm-12 conteudo'>
            <img class='rounded' src="img/imgAnimacao/classicos/img1Conteudo.webp" alt="Personagens principais de futurama olhando para cima.">
          </div>
