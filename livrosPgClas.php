...
<main>
  <div class='container'>
    ...
    <div class="row cntr">
      <article>
        ...
        <figure class="col-xl-2 col-md-4 col-sm-5">
          <img class="brdr" src="img/livros/fahrheit2.webp"  alt="Capa do livro com cor vermelho de fogo, o famoso livro Fahrenheit">
          <figcaption> Fahrenheit, 1990</figcaption>
        </figure>
        <div class="col-xl-4 col-md-7 col-sm-12">
        <h3 > Sinopse </h3>
          <p>Na cidade do futuro, que se apresenta totalmente controlada pelo governo, havia uma lenda de que, no passado, os bombeiros eram chamados apenas para apagar o fogo. Não havia literatura que mostrasse a ação de bombeiros no passado.Sem livros como referência do passado, tocar neste assunto era completamente proibido e, educados da maneira que foram, ninguém acreditava no que se falava dos bombeiros de antigamente.</p>
        </div>
    </article>
    </div>
    ...
    <section class="sla row justify-content-center"> 
      ...
      <section class="prs col-xl-2 col-md-5 col-sm-12 justify-content-center">
        <figure>
          <img class="brdr" src="img/livros/failustra(3).webp" alt="Imagens com referência ao tema distópico do livro.">
        </figure>
        <!-- <hr> -->
      </section>
      <section class="prs col-xl-2 col-md-5 col-sm-12 justify-content-center">
        <figure>
          <img class="brdr"  src="img/livros/failustra(4).webp" alt="Imagens com referência ao tema distópico do livro.">
        </figure>
        <!-- <hr> -->
      </section>
      <section class="prs col-xl-2 col-md-5 col-sm-12 justify-content-center">
        <figure>
          <img class="brdr" src="img/livros/failustra(5).webp" alt="Imagens com referência ao tema distópico do livro.">
        </figure>
        <!-- <hr> -->
      </section>
      <section class="prs col-xl-2 col-md-5 col-sm-12 justify-content-center">
        <figure>
          <img class="brdr" src="img/livros/failustra(6).webp" alt="Imagens com referência ao tema distópico do livro.">
        </figure>
        <!-- <hr> -->
      </section>
    </section>
    ...
    <article class="row justfy-content-center">
      ...
      <figure class="col-xl-4 col-md-6 col-sm-12 justify-content-center">
        <img class="brdr"src= "img/livros/ray.webp"   alt="Imagem do autor do livro 'Fahrheit', Ray Bradbury.">
        <figcaption>Bradbury, 1920-2000</figcaption>
      </figure>
      <!-- </article> -->
    ...
    <section>
      <h2 class="titulos">Outros Clássicos</h2>
    <!-- </div> -->
        ...
        <article class="noticia rounded-3  border d-flex align-items-center">
          <div class="noticiaSeila d-flex flex-column">
            ...
            <figure>
             ...
             <figcaption>Duna, 2001</figcaption>
            </figure>
            <p>Duna conta a história de Paul Atreides, jovem talentoso e brilhante que nasceu com um destino grandioso, para além até da sua própria compreensão, e precisa viajar ao planeta mais...
            <a href="livrosPgClas2.php">Continuar lendo...</a></p>
          </div>
        </artilce>
        <article class="noticia rounded-3  border d-flex align-items-center">
          <div class="noticiaSeila d-flex flex-column">
          <small>Sinopse</small>
            ...
            <figure>
              ...
              <figcaption>Robô, 1990</figcaption>
            </figure>
            <p>Um dos maiores clássicos da literatura de ficção científica, Eu, Robô, escrito por Isaac Asimov, é um conjunto de nove contos, interconectados pela Dra. Susan Calvin, que apresenta seus...
            <a href="livrosPgClas4.php">Continuar lendo...</a></p>
          </div>
        </article>
    </div>
  </div>
