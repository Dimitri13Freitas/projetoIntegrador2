    ...
    <div class='container'>
      ...
      <div class="row bannersinopse">
        <div class="col-lg-12 col-md-12 col-sm-12">
          <figure>
            <img class="border border-5" src="img/imgFilmes/imgLigaDaJustica.jpg" alt="banner do filme Liga da Justiça com Flash, Superman, Ciborgue, Mulher Maravilha, Batman e Aquaman um ao lado do outro">
            <figcaption class='sumir'>Imagem do filme Liga da Justiça</figcaption>
          </figure>
        </div>
      </div>
      </section>
