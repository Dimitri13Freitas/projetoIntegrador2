...
<footer>
  <h2 class='h1 p-5 titulo footertiulo pt-4 pb-3'>Mapa do site</h2>
  <nav class='navFooter container py-0'>
    <ul class='listaPrimaria d-flex pb-4 justify-content-between flex-wrap'>
      ...
      <li class='p-2'><a aria-label='contato.php' class='p-2' href='contato.php'>Contato</a></li>
      <li class='p-2'><a aria-label='normas.php' class='p-2' href='normas.php'>Normas de uso</a></li>
      <li class='p-2'><a aria-label='quemSomos.php' class='p-2' href='quemSomos.php'>Quem somos</a></li>
    </ul>
  </nav>
</footer>
<p class='py-4 text-center m-0'>Los Fofuritos Sem Calça &copy; Alguns direitos reservados</p>
</div>";
