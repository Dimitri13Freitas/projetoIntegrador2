  ...
  <div class='container'>
    ...
    <article class="row cntr">
      ...
      <figure class="col-xl-2 col-md-4 col-sm-5">
        ...
        <figcaption>Crônicas Marcianas, 1970</figcaption>
      </figure>
    ...
    <div class="row justify-content-center">
      ...
      <h3 class="titulos"> Análise Crítica, by Isabela Lapa </h3>
    ...
    <article class="row justify-content-center">
      ...
      <figure class="col-xl-4 col-md-6 col-sm-12 justify-content-center">
          ...
          <figcaption> Bradbury, Ray  1930-2004 </figcaption>
      </figure>
