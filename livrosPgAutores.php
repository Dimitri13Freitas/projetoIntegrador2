  ...
  <div class='container'>
    ...
    <div class="row">
      ...
      <div class="sla row justify-content-center"> 
        <h1 class="col-12 justify-content-center" style="text-align:center ;"> Principais produções </h1>
        <section class="principais col-xl-3 col-md-5 col-sm-12 justify-content-center border">
          <h2>seila</h2>
          <img style="width:100% ;" src="img/banner/img2.jpg" alt="">
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur eos quas voluptatibus incidunt pariatur laudantium excepturi, cupiditate esse perspiciatis quisquam saepe, doloribus itaque laboriosam nulla ab, voluptate quidem! Rerum, nostrum?</p>
        </section>
        <section class="principais col-xl-3 col-md-5 col-sm-12 justify-content-center border">
          <h2>seila</h2>
          <img style="width:100% ;" src="img/banner/img2.jpg" alt="">
    ...
    <div>
      <h3 class="titulo2 sla">Notícias</h3>
    </div>
    <div class="d-flex justify-content-xl-around flex-md-wrap flex-xl-nowrap flex-lg-nowrap flex-sm-wrap flex-wrap justify-content-md-center justify-content-sm-center mt-4 noticiaContainer">
        <section class="noticia rounded-3  border d-flex align-items-center">
          <div class="noticiaSeila d-flex flex-column">
