      ...
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 sinopse">
          <article>
            ...
            <!-- Fonte:https://www.adorocinema.com/filmes/filme-242492/ -->
          </article>
        </div>
      </div>
      <div class="row bannersinopse">
        <div class="col-lg-12 col-md-12 col-sm-12">
          <img  class="border rounded border-5" src="img/imgFilmes/imgJurassic.jpg" alt="Imagem do banner do filme jurassic world">
        </div>
      </div>
    </div>
