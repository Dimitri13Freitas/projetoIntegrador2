            ...
            <section class="row lado1img rounded border  p-3">
              <div class="col-lg-7 col-md-6 col-sm-12">
                <article>
                  ...
                  <p>Um chimpanzé de laboratório desenvolve inteligência e emoções humanas e uma batalha épica surge para determinar qual espécie será dominante no planeta Terra.</p>
                </article>
              </div>
              <div class="col-lg-5 col-md-6 col-sm-12 m-0 p-0">
                <aside>
            ...
            <section class="row lado1img rounded border  p-3">
              <div class="col-lg-7 col-md-6 col-sm-12">
                <article>
                  ...
                  <p>Cypher embarca em uma viagem espacial ao lado do filho Kitai, mas uma chuva de asteroides força a dupla a pousar na Terra, que há mil anos não é habitada por humanos. Cypher é gravemente ferido e Kitai precisa enfrentar grandes perigos na busca do sinalizador, o único objeto que pode ajudá-los a voltar para casa</p>
                </article>
              </div>
              <div class="col-lg-5 col-md-6 col-sm-12 m-0 p-0">
                <aside>
        ...
        <div class="col-lg-4 col-md-12 col-sm-12 sugestao">
          <ul class="border border-4 rounded p-0 p-2">
            ...
            <li>
              ...
              <a href="SinopseVenom.php" class="btn-primary btn">Clique aqui</a>
            </li>
            <li>
              <h4>Morbius</h4>
              <p>O bioquímico Michael Morbius tenta curar-se de uma doença rara no sangue mas, sem perceber, ele fica infectado com uma forma de vampirismo</p>
              <a href="SinopseMorbius.php" class="btn-primary btn">Clique aqui</a>
            </li>
            <li>
              <h4>Liga da Justiça</h4>
              <p>Impulsionado pela restauração de sua fé na humanidade e inspirado pelo ato altruísta do Superman, Bruce Wayne convoca sua nova aliada Diana Prince para o combate contra um inimigo ainda maior, recém-despertado. Juntos, Batman e Mulher-Maravilha buscam e recrutam com agilidade um time de meta-humanos, mas mesmo com a formação da liga de heróis sem precedentes, pode ser tarde demais para salvar o planeta.</p>
              <a href="SinopseLigaDaJustica.php" class="btn-primary btn">Clique aqui</a>
            </li>
          </ul>
        </div>
      </div>
