    ...
    <div class='container'>
      ...
      <div class="row bannersinopse">
        <div class="col-lg-12 col-md-12 col-sm-12">
          <figure>
            <img class="border border-5" src="img/imgFilmes/imgDepoisDaTerra.jpg" alt="Imagem com os rostos do ator Will Smith e seu filho Jaden Smith no plano principal.">
            <figcaption class='sumir'>Imagem do filme Depois da Terra</figcaption>
          </figure>
        </div>
      </div>
      </section>
